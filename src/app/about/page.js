        ...
        <div>
            <section className={styles.AboutPage_introSection}>
                ...
                <p className={styles.AboutPage_introSection_text}>
                    ...
                    Nemo quam ab suscipit ex dignissimos. Recusandae, labore
                    temporibus eaque consequatur maiores sed aliquam adipisci
                    eos provident assumenda quis, sapiente nobis. Debitis!
                </p>
            </section>
            <section className={styles.AboutPage_infoSection}>
                ...
                <Link
                    href="/blog"
                    className={styles.AboutPage_infoSection_blogLink}
                >
            ...
            <section className={styles.AboutPage_approachSection}>
                ...
                <p className={styles.AboutPage_approachSection_text}>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Aliquid, voluptatum. Architecto officiis quis, dolores
                    exercitationem consequuntur rerum autem labore ipsa amet
                    fugit voluptatum corrupti dolor magni odit unde quasi iste!
                    Hic, minima repellat sed earum autem sapiente et optio eum
                    minus magni. Alias, dolorum! Sunt, hic obcaecati error nobis
                    vel voluptatibus animi, possimus ad, debitis necessitatibus
                    incidunt quod corrupti fuga? Mollitia est ea ipsum
                    perferendis velit ab iste quisquam blanditiis omnis
                    suscipit, exercitationem qui impedit dicta, hic voluptatum
                    maxime? Aliquam atque illo incidunt sed deleniti, magni
                    nostrum! Quidem, culpa harum. Odit harum libero eius
                    deleniti cum perspiciatis vero quas veritatis? Excepturi
                    officiis fugiat in saepe consectetur odio voluptas atque
                    iste perspiciatis. Amet eligendi harum distinctio recusandae
                    repellat? Ea, eos sit!
                </p>
            </section>
        </div>
